    ...
    <div className="min-h-screen bg-slate-950 text-white overflow-x-hidden font-syne">
                ...
                },
      {
                ...
                },
       {
                ...
                },
                {
                  ...
                  img: "/recall.jpg",
                  link: "https://www.imdb.com/title/tt34476668/"
                },
                {
                  slug: "life-and-dirt",
                  title: "Life and Dirt",
                  ...
                  img: "/lifeanddirt.jpg",
                  link: "https://www.imdb.com/title/tt33363825/"
                },
                {
                  slug: "djalifa",
                  title: "Djalifa",
                  ...
                  img: "/djalifa.png",
                  link: "https://www.imdb.com/title/tt34425275/"
                },
                {
                  slug: "ijogbon",
                  title: "Ijogbon",
                  ...
                  img: "/ijogbon.jpg",
                  link: "https://www.imdb.com/title/tt29168830/"
                },
                {
                  ...
                  link: "https://www.imdb.com/title/tt15565704"
                },
                {
                  slug: "the-tribunal",
                  title: "The Tribunal",
                  desc: "A legal drama exploring justice and redemption.",
                  img: "/TheTribunal.jpg",
                  link: "https://en.wikipedia.org/wiki/The_Tribunal_(2017_film)"
                },
                {
                ...
                .map((work, idx) => (
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col p-4">
                      ...
                      {/* Removed leftover Link tag for View Details button */}
                        <Link href={work.link} target="_blank" rel="noopener noreferrer" className="flex justify-center mt-auto w-full">
                          <span className="inline-flex items-center justify-center w-full">
                            {/* IMDB Logo Button */}
                            <span className="bg-yellow-400 hover:bg-yellow-500 text-black font-bold px-3 py-1.5 rounded-full w-full flex items-center justify-center gap-2 transition-colors duration-200">
                              <span className="sr-only">IMDB</span>
                              {/* Use ImdbLogo SVG component */}
                              {require("@/components/ui/imdb-logo").ImdbLogo({})}
                            </span>
                          </span>
                        </Link>
                    </div>
      ...
      <section id="awards" className="py-32 px-6 bg-slate-900 border-t border-slate-800">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-5xl md:text-7xl font-bold mb-16 tracking-tight text-center bg-gradient-to-r from-white via-cyan-200 to-cyan-400 bg-clip-text text-transparent">
            Awards & Recognition
          </h2>
          <div className="relative border-l-4 border-cyan-700 pl-8 flex flex-col gap-16">
            {/* Step 1 */}
            <div className="flex items-center gap-8">
              <div className="flex flex-col items-center">
                <span className="bg-cyan-700 w-8 h-8 rounded-full flex items-center justify-center mb-2">
                  <Award className="w-6 h-6 text-white" />
                </span>
                <div className="h-full w-1 bg-cyan-700/40 flex-1" />
              </div>
              <div className="flex flex-col md:flex-row items-center gap-8 bg-slate-950/90 rounded-2xl p-8 border border-cyan-700 shadow-xl w-full">
                <Image src="/Anikulapo-1.webp movie.jpg" alt="Anikulapo Movie Poster" width={120} height={150} className="rounded-xl object-cover border-4 border-cyan-500 shadow-md" />
                <div className="flex-1 text-center md:text-left">
                  <h3 className="text-2xl font-bold text-white mb-2">Anikulapo (Movie)</h3>
                  <p className="text-cyan-400 mb-1 text-lg">AMVCA 2023: Best Sound Editor</p>
                  <p className="text-slate-400 text-base">Africa Magic Viewers' Choice Awards</p>
                </div>
              </div>
            </div>
            {/* Step 2 */}
